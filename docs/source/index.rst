...
A Python library for participating in the `ECMWF AI Weather Quest <https://aiweatherquest.ecmwf.int>`__.
...
.. note::
   ...
   This project is being actively developed. New updates may be released periodically with detailed annoucements given on the `AI Weather Quest Forum <https://forum.ecmwf.int/c/workshop-and-events/ai-weather-quest/41>`__.
